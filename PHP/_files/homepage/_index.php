    ...
    <body>
                ...
                <div class="col-md-8">
                    <div class="box index">
                        <h2 style="margin-bottom:30px;">
                            <center>Willkommen bei GhostChat!</center>
                        </h2>
        ...
        <script>
            ...
            window.onload = function () {
                AddMessage("Tippe folgende Zahl in den Chat um fortzufahren! <br> <b>1. Einloggen</b> <br> <b>2. Registrieren</b> <br><br> Solltest du dich vertippen, gebe einfach exit ein!", 1);
            };
